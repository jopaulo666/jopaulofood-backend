package br.com.jopaulo.jopaulofood.application.test;
...
import br.com.jopaulo.jopaulofood.domain.restaurante.ItemCardapio;
import br.com.jopaulo.jopaulofood.domain.restaurante.ItemCardapioRepository;
...
//		pedidoRespository.save(p);
	...
	private Restaurante[] restaurantes() {
		...
		r.setSenha(br.com.jopaulo.jopaulofood.util.StringUtils.encrypt("r"));
		r.setCnpj("00000000000101");
		r.setTaxaEntrega(BigDecimal.valueOf(3.2));
		r.setFone("99876671010");
	...
	private Cliente[] clientes() {
		...
		c.setSenha(br.com.jopaulo.jopaulofood.util.StringUtils.encrypt("c"));
		c.setCep("89300100");
		c.setCpf("03099887666");
		c.setFone("99355430001");
		clientes.add(c);
